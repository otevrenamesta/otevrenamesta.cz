<template>
  <section>
    <div class="container flex mb-block-2 flex-col xl:flex-row">
        ...
        <div class="sm:aspect-w-1 sm:aspect-h-1 sm:bg-additional sm:rounded-full flex items-center justify-center">
          <div class="flex">
            <p class="px-0 py-14 sm:py-20 xs:py-10 flex flex-col justify-center font-bold text-lg sm:w-8/12 mx-auto text-black/80">
              ...
              <span
                v-preposition-space
                class="font-semibold text-xl text-secondary sm:text-black/60 [&_a]:underline"
      ...
      <div
        id="form"
        class="w-full xl:w-1/2 bg-secondary px-block-1 md:px-block-1 xs:px-block-0.5 py-block-1 mb:py-block-1.5 flex flex-col justify-center"
      >
        <CzechOspoForm />
      </div>
    </div>
...
export default {
  ...
  computed: {
    support() {
      return useContentStore().czechOspo.support;
    },
  },
};
</script>
